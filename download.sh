...
cat other_compressed_split.zip.* > other_compressed_split.zip
unzip other_compressed_split.zip
unzip other_compressed.zip
rm -f other_compressed_split.zip.*
rm -f other_compressed_split.zip
rm -f other_compressed.zip
